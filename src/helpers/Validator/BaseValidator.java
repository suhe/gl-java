 ...
 * @author BDO-IT
 */
public abstract class BaseValidator extends InputVerifier implements KeyListener {
    /**
    ...
    */
    ...
    private BaseValidator(JComponent c, String message) {
        this();
        c.addKeyListener(this);
        messageLabel = new JLabel(message + " ");
        image = new JLabel(new ImageIcon(getClass().getResource("/resources/icons/error_16X16.png")));
    }
    ...
    public BaseValidator (JDialog parent, JComponent c, String message) {		
        this(c, message);
        this.parent = parent;
    ...
    public boolean verify(JComponent c) {		
        if (!validationCriteria(c)) {
            ...
            if(parent instanceof StatusValidator)
                ((StatusValidator)parent).validateFailed();
        ...
        if(parent instanceof StatusValidator)
            ((StatusValidator)parent).validatePassed();
